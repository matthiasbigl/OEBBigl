...
<div bind:this={pageContainer} class="min-h-screen bg-black text-gray-100 font-mono relative overflow-hidden">
	...
	<div class="relative z-10 min-h-screen flex flex-col">
		...
		<div bind:this={searchContainer} class="px-3 py-3 sm:px-6 lg:px-8 relative z-20">
			<div class="max-w-6xl mx-auto">
		...
		<div bind:this={journeysContainer} class="flex-1 px-3 py-3 sm:px-6 lg:px-8 pb-20">
			<div class="max-w-6xl mx-auto">
